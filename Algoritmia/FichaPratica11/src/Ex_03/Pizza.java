...
public class Pizza {
    ...
    public void exibirDetalhes() {
        ...
        for (IngredientePizza ingredientePizzaAtual : this.listaIngredientesPizza) {
            ...
            // Este é o método abstrato de Ingrediente, só conseguimos invocar porque temos a certeza que ele existe em todos os Ex_03.Ingredientes (inclusive descendentes)
